                ...
                <div class="panel panel-success panel-stat">
                    <div class="panel-heading">
                        ...
                        <div class="stat">
                            <div class="row">
                                <div class="col-xs-4">
                                    <img src="/backend/images/is-user.png" alt="" />
                                </div>
                                <div class="col-xs-8">
                ...
                <div class="panel panel-danger panel-stat">
                    <div class="panel-heading">
                        ...
                        <div class="stat">
                            <div class="row">
                                <div class="col-xs-4">
                                    <img src="/backend/images/is-document.png" alt="" />
                                </div>
                                <div class="col-xs-8">
                ...
                <div class="panel panel-dark panel-stat">
                    <div class="panel-heading">
                        ...
                        <div class="stat">
                            <div class="row">
                                <div class="col-xs-4">
                                    <img src="/backend/images/is-money.png" alt="" />
                                </div>
                                <div class="col-xs-8">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="panel panel-default widget-photoday">
                    <div class="panel-body">
                        <a href="" class="photoday"><img src="/backend/images/photos/photo1.png" alt="" /></a>
...
@section('scripts')
    <script src="{{ asset('backend/js/flot/flot.min.js') }}"></script>
    <script src="{{ asset('backend/js/flot/flot.resize.min.js') }}"></script>
    <script src="{{ asset('backend/js/morris.min.js') }}"></script>
    <script src="{{ asset('backend/js/raphael-2.1.0.min.js') }}"></script>
